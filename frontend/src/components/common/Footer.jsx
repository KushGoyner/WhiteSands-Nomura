    ...
    <footer className='border-t py-12'>
        <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
            <div >
                ...
                <p className='text-gray-500 mb-4'>
                    The WhiteSands team releases newsletters regularly to give all its patrons and supporters a clear idea of all the projects and upcoming initiatives.
                </p>
                <p className='font-weight text-sm text-gray-600'>
                    Sign up and get newsletters.
                </p>
                <form className='flex '>
            ...
            <div>
                ...
                <li>
                    <Link to={"#"} className='hover:text-gray-600 transition-colors'>Events</Link>
                </li>
                <li>
                    <Link to={"#"} className='hover:text-gray-600 transition-colors'>Gallery</Link>
                </li>
                <li>
                    <Link to={"#"} className='hover:text-gray-600 transition-colors'>Volunteer </Link>
                </li>
                </ul>
            </div>
            {/* Support Links */}
            ...
            <div>
                ...
                <p className='text-gray-500' >Call Us
        ...
        <div className='container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6'>
            <p className='text-gray-500 text-sm tracking-tighter text-center' >
                ©️ 2025, WhiteSands. All Rights Reserved.
            </p>
        </div>
    </footer>
  )
